const ButtonSvg = (black) => (
  <>
    ...
    >
      <path
        fill={black ? "black" : "none"} // change white to black
        stroke={black ? "black" : "url(#btn-left)"} // change white to black
        strokeWidth="2"
    ...
    >
      {black ? (
        <polygon
          fill="black" // change white to black
          fillRule="nonzero"
    ...
    >
      <path
        fill={black ? "black" : "none"} // change white to black
        stroke={black ? "black" : "url(#btn-right)"} // change white to black
        strokeWidth="2"
